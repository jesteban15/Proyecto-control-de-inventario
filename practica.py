...
class App(tk.CTk):
    def __init__(self):
        ...
        self.checkbox_frame_1 = MyCheckboxFrame(self, "Values", values=["Value 1", "Value 2", "Value 3", "Value 4"])
        self.checkbox_frame_1.grid(row=0, column=0, padx=10, pady=(10,0), sticky="nsew")
        self.radiobutton_frame_1 = MyRadiobuttonFrame(self, "Options", values=["Option 1", "Option 2"])
    ...
    def button_callback(self):
        ...
        print("Radiobutton_frame:", self.radiobutton_frame_1.get())
